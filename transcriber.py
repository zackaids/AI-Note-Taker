# transcriber.py
# program that will read the mp3/mp4/etc files and transcribe them
...
def amazon_transcribe(audio_file_name, transcribe):
    job_uri = "s3://transcriptiontrainingaudio/" + audio_file_name
...
data = amazon_transcribe("VOXTAB_MarketResearch_audio.mp3", transcribe)
